...
## 📱 What is Redmi-10A_GPU_Performance_Unlock?
...
### Step 4: Transfer the Magisk Module to Your Phone
...
2. Go to Modules and confirm the Redmi-10A_GPU_Performance_Unlock module is active.
3. Use any GPU monitoring or benchmark app on your phone to see improved performance.
4. The phone should run smoother with better graphics handling and no overheating.

---

## 📋 Features of Redmi-10A_GPU_Performance_Unlock
...
## 🖥️ How to Install ADB Tools on Windows

You may need ADB to check your phone or update Magisk.

1. Download Minimal ADB and Fastboot from a trusted source.
2. Run the installer with default options.
3. Open Command Prompt.
4. Connect your phone with USB debugging enabled.
5. Test connection with this command: `adb devices`.
6. You should see your device listed.
